...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.1            | 2026-08-15 | **2026-W33**：upstream `cd9fbf9f1 → 45af7a71f`（周内 +1745 commits）。主线：周初完成 CVE、v34 personality、Gateway route/session、Browser Use 与 Windows/Desktop updater 收敛；随后补齐跨 surface `/model`/resume、后台通知与 secrets redaction、compression/model catalog、Slack streaming/task cards；本轮继续加强 updater stale-lock/shallow/native recovery、Gateway/cron drain 与 stale-claim、`key_cmd` secret source、`/save`/`/export`，以及 Desktop 多实例、多源 agent、未读状态、查找、附件和命名浏览器 session。PATCH：周内 **+6 / 2 归档 / 0 收缩**，终态 **34 活跃**；新增 `PATCH-LAUNCHD-WRAPPER-SUPERVISOR` 修复新 stderr wrapper 丢失 supervisor identity 导致的 launchd respawn/refuse P0，sandbox verifier 同时核对 wrapper PID 与真实 Gateway 子进程 PID。注册表规整为 8 类，活跃定义全部连续置于 Archive 前；`PATCH-GEMINI-CROSS-PROVIDER-TOOL-HISTORY` 从误置 Archive 恢复到活跃区（仅结构纠正）。bundle **68 files**，最终 **30 files / 1139 passed / 0 failed / 3 skipped**，full-index/cached/reverse/index-clean 全绿。配置链保持 `azure-foundry/gpt-5.5 → bedrock/Claude Opus 5 → vertex/google/gemini-3.5-flash`，compression 为标准 Vertex，统一 cap 700k；v35 → v37 按官方迁移把 subagent iterations 50→250、并发 3→10。15 个 bundled skills 更新；npm 仍 6 high，均为 Electron/postcss/nanoid 的 Desktop/web build 链 P2，不影响飞书主链路，禁止 `--force`。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
