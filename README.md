...
Step 8e 当前为 `PATCH-FEISHU-GROUP-SANDBOX` 运行 126 条行为测试，并在同一 verifier 中继续执行身份同步与飞书文档媒体脚本回归；owner DM 的 fixed reader → chat-hash 私有 workspace → HyperTeX staging 正例、当前消息 Markdown 资源链接后紧接 CJK 正文的 provenance 正例，以及历史手工目录/任意外部路径/未引用资源反例均属于硬门槛。
...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.6            | 2026-09-03 | **2026-W36**：本周未获取新 upstream，内层固定 `11c8c05dc3`。9 月 3 日飞书文档事故与全 PATCH 深审修复：Sheets Markdown 链接后紧接正文时的 provenance 误判、53.8 MiB PPTX 的 8 秒回填超时、附件完整缓冲/文件数后置、跨 worker 单轮调用门禁、宿主路径输出、纯图片 PPTX 完整性误报、配置与 credential fail-open、显式 vision route 被 ambient fallback 绕过、configured-only route 元数据丢失、MCP task 回执可伪造、skill scope/cache 与 create-root 降级，以及 update/final-audit 的事务锁、状态写、stash 冲突、cleanup 进程探针、跨 workspace agent 误阻塞、bundle/base/lockfile 审核缺口均已收束。sandbox 升至 `0.7.13`；权限来源与群工具面未扩大，附件 deadline 仍有界。终态数字以本轮 final-audit 为准：**53/53 full PATCH evidence**、canonical **41 files / 2007 passed / 0 failed / 6 skipped**、另有 2 个 test support modules、93-file bundle、35 active + 7 archived gates、sandbox/identity-sync **158 passed**。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
