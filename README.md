...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.21.0            | 2026-09-11 | **2026-W37**：9 月 11 日在当前 SHA 收敛飞书新版组合消息：顶层 files 复用既有附件下载/抽取链，兼容旧内嵌文件并去重；补齐真实事件到私聊/群 Gateway turn 的 47 项边界回归及快照缺项/错计数/错序负例。完成无网络 reconcile、双 PID/plugin 验证和完整终态审计；自演进增补新格式/SDK 验收，修订 canonical/reconcile 串行和按需提交条件；无新可退役项，69 项 auditor 回归通过，成功深审游标已更新。固定在 upstream `79445a496c`，本轮只做 no-fetch `--reconcile`。增强 `PATCH-LOCAL-PROFILES` 的默认称呼契约：`address` 显式值继续最高优先；缺省时由代码只基于公开 `name` 确定性生成中/英文候选，prompt 仅控制是否自然使用，不再依赖历史模仿。中文双字名可缩短（`安媛媛 → 媛媛`），单字名和低置信布局保留全名，已知复姓保守分割；英文支持 `Given FAMILY`、大写姓前置和单词姓名。aliases、括号昵称与历史消息不参与推导，派生值同步进入公开 redactor 集。实现、回归、`PATCHES.md`、playbook 隐私不变量与 Step 8b sentinel 已共演进；同日完成 Bedrock fallback 到 `claude-sc/claude-fable-5-1` 的等价迁移：采用用户级 model-provider 插件，无新增内层 provider patch，并将 Bedrock 专项图片识别、output-cap 接线和状态样例替换为 SC 配置能力与通用恢复路径；当前 canonical patch suite **45 files / 2259 passed / 0 failed / 6 skipped**，另有 2 个 test support modules、full PATCH evidence **2265 collected**、22/22 probe、119-file bundle、36 active + 7 archived gates、sandbox/identity-sync **161 passed**；Gateway 排空后重启加载新规则。同日实时读回并将群 `oc_4fedab188b969db25dfdb591b74fcfab` 的名称从“FDE 第四把交椅”更新为“FDE 庶民群”。npm audit 当前余 11 项（2 moderate / 9 high，涉及 Vitest、Electron、extract-zip、js-yaml 等上游范围），修复需 `--force` 跨越上游声明范围，按 P2 保留且不扩权处理。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
