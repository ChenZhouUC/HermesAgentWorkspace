...
> 本 README 下文出现的所有 `hermes gateway restart` 都继承同一前置要求：先运行 cleanup dry-run，确认所有 outer/inner operational scripts 与 ignored 路径均已分类且 `review=0`，再执行 apply。`review` 项必须先更新 `scripts/cleanup_policy.json` 和测试，不能直接删除。
...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.5            | 2026-08-22 | **2026-W34**：upstream `8ad055414 → 4a6b362178`（累计 +1533 commits），升级到 v0.20.5。周内主线扩展到 Gateway/systemd handoff、State/SQLite 原子恢复、Bot Mode canonical chat 与 agent messaging、更新器多 profile/分支策略/结构化回执、Browser/Desktop artifact 与渲染边界，以及 Bedrock Responses、OpenCode Free、GLM-5.3（`5b024c7ccc`、`27d661e171`、`e26d91dc11`、`1d74833d8d`、`847289864d`、`e5b96fcb10`）。逐项审计 42 active + 9 archive PATCH：本轮 15 个原受管路径与上游相交但语义正交，88-file bundle clean apply；无新增吸收/归档/收缩，`PATCH-DOCUMENT-EXTRACTION` 仍为既有部分吸收。PATCH evidence 同轮收紧为验证段测试必须真实进入权威 runner，并机器证明 34 个工程 PATCH 与 34 个 Step 8b gate 一一归属；补齐 9 个此前依赖邻近文本的定义。另修复截断工具调用的 ephemeral cap 未进入 Bedrock/Codex native 请求的问题，并增加两条 transport 回归。最终权威回归 **39 files / 1679 passed / 0 failed / 3 skipped**，34 active + 6 archived gates、bundle byte/cached/reverse/index-clean 全绿。自演进修复两项 P0：`config.yaml.corrupt.*.bak` 恢复快照纳入 cleanup keep policy；新增 `hypertex_list_case_types` 后，按 owner 引擎信息敏感度纳入既有 HyperTeX trusted-chat + trusted-actor + one-call 边界，sandbox **54 passed** + **6 identity-sync tests**。官方 Skills mirror `+1/~0/-0`（新增 `research/llm-wiki`）。root `npm audit` 去重后剩 6 high；Doctor 按 workspace 显示 Web 4 high + UI-TUI 3 high（有重叠），均为 Vite peer/构建工具链 P2，`npm audit fix` 因上游 `ERESOLVE` 阻挡，不影响飞书主链路且未使用 `--force`。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
