...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.6            | 2026-09-04 | **2026-W36**：本周未获取新 upstream，内层固定 `11c8c05dc3`。9 月 3 日飞书文档事故与两轮全 PATCH 深审修复：Sheets Markdown+CJK provenance、53.8 MiB PPTX 回填超时与混合图文覆盖误报、附件流式预算/deadline/显式失败、跨 worker claim、宿主路径、损坏配置 credential/configured-only fail-open、多 endpoint route、MCP task provenance 持久化、skill scope，以及 update/final-audit 的原子锁、完整状态快照、stash/EXIT、cleanup 跨 workspace 进程归属、bundle/base/lockfile 审核缺口均已收束。sandbox 升至 `0.7.14`；权限来源与群工具面未扩大。9 月 4 日扩展 `PATCH-FEISHU-GROUP-ADMISSION`：第三方 @本人 时由独立无工具辅助模型仅查看当前正文和直接 quote，输出结构化 AI 代写评分；全局 `1.1` 关闭，私有 people profile 可按稳定 ID 覆盖。未披露且达到阈值时由 adapter 在主 Agent 前本地短路，以 Gödel 的公开 AI 身份严肃但礼貌地反对该行为并代表本人拒绝回答；具体人员配置不进入受跟踪文档。同轮修复 PATCH evidence 在 hermetic `npm audit` 超时时误报回归缺失的问题，现按 P2 `telemetry_unavailable` 记录，critical 仍阻断。终态数字以本轮 final-audit 为准：**53/53 full PATCH evidence**、canonical **41 files / 2043 passed / 0 failed / 6 skipped**、另有 2 个 test support modules、95-file bundle、35 active + 7 archived gates、sandbox/identity-sync **161 passed**。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
