...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.4            | 2026-08-19 | **2026-W34**：upstream `8ad055414 → 13ce0c5c6`（+836 commits），版本 v0.20.1 → v0.20.4；主线迁移 MCP 2.x + stateless protocol/OAuth，新增 project-local skill trust/quarantine 与安装安全，修复 profile-aware Gateway/session、launchd wrapped child supervisor，并持续扩展 provider catalog、Desktop 多 source/Bot Mode/preview/browser/tour 与 Nix Home Manager。周内本地先建立 `PATCH-MCP-TASKS-ASYNC-HANDOFF`（task handle 持久化后确定性回执、无第二次 LLM）和 HyperTeX 群 ID + 用户 ID 双 allowlist，随后新增 `PATCH-GATEWAY-RESTART-CLEANUP` 三态审计。升级时 84-file bundle 在 prompt/skill、gateway、approval、MCP 五处真实冲突；四处按上游新能力与本地不变量并存重解，`PATCH-LAUNCHD-WRAPPER-SUPERVISOR` 经 `7008fb81b3` 与 14 条官方回归证明完全吸收并归档。cleanup 续审补齐未完成事务状态文件 keep 与新 `website/**/__pycache__` remove 分类，MCP Tasks extension 适配 2.x `is_error` 字段并加成功/error validation 反例；HyperTeX 与群文档 delete 授信扩为周琛、孙可天、张文华、李冰洁四人（各登记 open_id + user_id），create/append/rebuild 对群成员开放且不扩大 assistant-user mention trigger；HyperTeX create 不再强制 `codex`，改由 `hermes` 账号权重抽取，iterate 沿用 case 原 Agent。终态 **38 active / 30 engineering / 82 files / 37 tests**，规范 runner **1340 passed / 0 failed / 3 skipped**，sandbox **41 passed**，Step 8b/8e、bundle/base/full-index、cached 正向、worktree 反向、index-clean、playbook/transaction/cleanup self-test 全绿；Gateway planned restart 后 launchd wrapper 与真实子进程均健康，配置仍为 v37。root 仍 6 high，均为 Electron/postcss/nanoid 上游 lock/range 阻挡的 Desktop/Web build-chain P2，不影响飞书主链路，未使用 `--force`。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
