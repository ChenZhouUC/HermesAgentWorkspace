...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.6            | 2026-09-04 | **2026-W36**：本周未获取新 upstream，内层固定 `11c8c05dc3`。9 月 3 日飞书文档事故与两轮全 PATCH 深审修复：Sheets Markdown+CJK provenance、53.8 MiB PPTX 回填超时与混合图文覆盖误报、附件流式预算/deadline/显式失败、跨 worker claim、宿主路径、损坏配置 credential/configured-only fail-open、多 endpoint route、MCP task provenance 持久化、skill scope，以及 update/final-audit 的原子锁、完整状态快照、stash/EXIT、cleanup 跨 workspace 进程归属、bundle/base/lockfile 审核缺口均已收束。sandbox 升至 `0.7.14`；权限来源与群工具面未扩大。9 月 4 日扩展 `PATCH-FEISHU-GROUP-ADMISSION`：任何发送者 @本人 时，由独立无工具辅助模型仅查看匿名化当前正文和直接 quote，按本地 per-sender 阈值判断未披露 AI 代写；本人不再因 configured-human 身份绕过。Markdown/规整列表校准增强，分类器 10 秒单次请求、无同 provider 重试和跨 provider fallback。高分由 adapter 在主 Agent 前本地拒绝，低分/披露后仍走原画像链路。群回复把当前发送者及正文中所有能由热加载人员索引解析的 `@姓名/别名` 原位转为同一 `md.text` 内的 Feishu 原生 mention，缺失当前发送者时自动补，避免独立 post 元素造成换行。模型 fallback/恢复/超时/最终 provider failure 全部只进日志；Codex `<50k` 首字节后事件 idle 阈值从 12 秒修正为 60 秒。同轮修复 PATCH evidence 在 hermetic `npm audit` 超时时误报回归缺失的问题，现按 P2 `telemetry_unavailable` 记录，critical 仍阻断。终态数字以本轮 final-audit 为准：**53/53 full PATCH evidence**、canonical **43 files / 2113 passed / 0 failed / 6 skipped**、另有 2 个 test support modules、98-file bundle、35 active + 7 archived gates、sandbox/identity-sync **161 passed**。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
