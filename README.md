...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.4            | 2026-08-20 | **2026-W34**：upstream `8ad055414 → 13ce0c5c6`（+836 commits），Hermes v0.20.1 → v0.20.4；主线迁移 MCP 2.x/stateless OAuth，补强 profile-aware Gateway/session、project skill trust、launchd wrapper supervisor，并扩展 provider、Desktop/Web 与 Nix 支持。84-file 旧 bundle 在 prompt/skill、gateway、approval、MCP 五处真实冲突，均按“上游新接口 + 本地安全不变量并存”重解；`PATCH-LAUNCHD-WRAPPER-SUPERVISOR` 经官方实现与 14 条回归证明吸收归档，工程 overlay 收敛为 85 文件。MCP Tasks 适配 SDK 2.x `name_param`、错误字段与 legacy result 预校验，task handle 改为确定性回执并结束当前 turn；exact taskId + 只读 suggested-ID 单次重试区分了 ID 误用和 transport 超时。群聊侧新增 failover 状态静默、截断工具参数有界重试、3000 字回复预算/16k post fallback、deferred `tool_call` 单层双包恢复和 180 秒 generic 长任务心跳。财务群 PDF/HyperTeX、SpaceSight 文档创建和 Data Pipeline 文档 provenance 的真实复盘均已穿过最高有效边界回归。HyperTeX 现开通 4 个群、5 名维护者，文档 delete 仅 owner；配置只登记 people.yaml 的 open_id，sandbox 从签名事件精确归一 open_id/user_id/union_id，修复日志展示 open_id、实际 SessionSource 选择 tenant user_id 导致的 8 次本地误拒。组织同步已为 218 人持久化完整唯一的 open_id↔user_id，缺失/重复 fail closed，并由 Step 8e 自动消费身份同步回归。终态 42 active / 34 engineering / 85 files / 39 tests；受管 runner **1654 passed / 0 failed / 3 skipped**（另 8 subtests），sandbox **53 passed** + **6 identity-sync tests**；34 个活跃 gate + 6 个归档 gate 均被总闸门消费，bundle byte/cached/reverse/index-clean 全绿。cleanup policy `review=0`，Gateway planned restart 与真实子进程 verifier 闭环成立。剩余 6 high 均为 Electron/postcss/nanoid 的上游 lock/range P2，不影响飞书主链路，未使用 `--force`。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
