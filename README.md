...
本项目维护若干针对上游 `hermes-agent` 的本地补丁，以修复已知 Bug 或定制行为。完整记录（问题描述 / 根因 / 修复方案）见 [`patches/PATCHES.md`](patches/PATCHES.md)。当前补丁基线已刷新到上游 `d02a59b6`（截至 2026-06-08 的 `main`，较 `a6b6afdff` 前进 699 commits，跨版本 v0.15.1 → v0.16.0）。
