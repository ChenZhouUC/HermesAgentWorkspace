...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.5            | 2026-08-27 | **2026-W35**：upstream `503d863fcd → 9aa7530f7b`（+889 commits），仍为 v0.20.5；主线覆盖 Desktop/fleet session、Gateway reconnect/profile route、update/SSH ownership、MCP transport/catalog、批量 Tool Search、lean compaction、terminal、安全审批及 v39 BFL core-tool 迁移。轮询原 42 active + 9 archive PATCH：25 个活跃 PATCH 与 36 个受管路径重叠，5 个真实冲突按“上游增强 + 本地不变量并存”融合；无既有 PATCH 新吸收/归档/收缩，`PATCH-DOCUMENT-EXTRACTION` 保持部分吸收；新增 `PATCH-MCP-STDIO-WATCHER-LIFECYCLE` 修复 stdio watcher coroutine 双创建泄漏。工具链修复 quick evidence/bundle 顺序死锁、同版本跨周 README 误判及 Tool Search verifier 漂移。SpaceSight 群现场暴露新 `Model fallback:` 文案穿透旧 regex/测试/gate，现由生产 formatter 驱动 consumer 回归，聊天静默而 API 保留。主会话另抓到 HyperTeX 子进程存活被反向判死，现锁定 alive/dead/mixed 与真实 handler。逐 Patch 追审再发现 full evidence 可只命中任一 owned file、并借用未登记测试文件；现强制 node 归属对应 PATCH、逐文件执行全部 owned production `.py`，为 8 个多文件 PATCH 补齐直接轨迹，并修正 1 个 Patch 的错误 ownership。终态 **39 files / 1736 passed / 0 failed / 9 skipped**，88-file bundle、35 active + 6 archived gates、43+9 PATCH evidence、sandbox/identity-sync **60 passed**及 Gateway 双 PID 闭环。首次 HTTPS acquisition 因 HTTP/2 失败，仅恢复一次并以 SSH 443 固定目标；updater 自举 restart 遗留的 registered-but-down Gateway 已由 pinned reconcile 恢复。Skills mirror `+1/~0/-11`，config v38→v39。npm Web 4 high、UI-TUI 3 high 为 Vite peer/lock P2，未用 `--force`；可选 provider/tool 警告为 P3。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
