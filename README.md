...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.21.1            | 2026-09-11 | **2026-W37**：upstream `79445a496c → 3b45681c25`（+1732 commits），v0.21.1 / config v42。周内补齐飞书新版顶层 files、47 项真实入站边界回归、公开姓名确定性称呼与 SC Claude fallback；本次适配事件接口、nonstream worker、媒体 helper、MCP batch 与 profile scope 重构，14 文件语义解冲突。`PATCH-UPDATE-FLEET-RECEIPT-FRESHNESS` 部分吸收，保留严格 PID inventory；删除已由上游实现的重复测试 stub。清理规则新增嵌套 provider verifier、Wisdom 私有状态/bytecode、shared-state.db 与 restart marker；sandbox 搜索探针按单能力查询并核对实际 matches。上游取消 idle/daily 自动重置，移除失效配置，保留压缩/归档策略。本轮按用户要求仅做同 SHA 全量 PATCH 审计，不获取上游：修复群审批被隔离后端短路、external 缺省创建遗漏与错误 Skills 策略放行；审计器拒绝 unittest skip/expected-failure，镜像和 CJK 探针改验真实生产入口及产物，保留负向注入。群审批在公共决策与 Gateway 发卡出口统一拒绝，覆盖通用工具、直接通知、卡片和文字提示；纯扫描告警在 yolo/off、allowlist、历史批准与隔离后端之前拦截，新增 60 项成对回归，保留 DM 与无告警命令策略。新增管理命令权限补丁：群内新会话仅 owner 可发起，Gateway 重启/更新及 home 变更只限 owner 主 DM；拒绝先于 adapter 取消任务；原生 slash 确认也禁止群内发卡与关闭确认后直接执行。最终 canonical **46 files / 2623 passed / 0 failed / 6 skipped**，另有 2 个 test support modules、full PATCH evidence **2629 collected**、56/56 PATCH、22/22 probe、122-file bundle、37 active + 7 archived gates、sandbox/identity-sync **161 passed**。72 项 auditor 与 22 项 cleanup 回归通过；裸 upstream 的漏报 PID/探针故障负例证明剩余补丁必要。199 个 Python 包全部保留。P2：npm 11 项（2 moderate / 9 high）均在 Desktop/build/test 依赖链，修复需越上游范围；cryptography 元数据提示来自上游显式安全 override，不降级，均不影响飞书主链路。ChatBI 启动早期提示经复核为加载时序噪音；正式配置的 token/header 已解析，非缺凭据。                                                                                                                                                                                                                                                                                                                                                                               |
