...
# 5. 运行 53 条 sandbox 行为测试 + Feishu 组织身份同步回归，并检查当前 gateway PID 的 runtime 注册日志
```
...
| 8e   | **Verify user plugins**                   | 强制验证 `PATCH-FEISHU-GROUP-SANDBOX` 等配置仓库用户插件：verifier 必须存在且可执行；结构化检查 YAML/固定脚本与 people.yaml 的 open_id↔user_id 完整唯一映射，真实解析 owner/group toolset，运行 53 条行为测试并追加 Feishu 组织身份同步回归；用 Gateway 规范化的 `[URL](URL)` reply 穿过 deferred `tool_call` 验证可信群文档删除（fake script，零外部删除）；launchd wrapper 健康由 status 证明，插件注册 trace 绑定 `gateway.status.get_running_pid()` 返回的真实 Gateway 子进程 PID。任一失败令整次升级非零退出                                                                                                        |
...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.20.4            | 2026-08-20 | **2026-W34**：upstream `8ad055414 → c47f0b459`（累计 +1221 commits），Hermes 版本仍为 v0.20.4；本轮新增 5 个 Desktop sidebar/session-row 提交，未触及受管 PATCH 文件。审计补齐 `scripts/test_patch_evidence.py`，逐项覆盖 42 active + 9 archive PATCH、85-file bundle、runtime boundary 和 39 个规范回归文件，最终 **1671 collected / 0 failed**（规范 runner 前次实跑 1668 passed / 0 failed / 3 skipped）。本轮发现并修复 self-test 污染 `_REQUESTED_MODE` 导致 `--reconcile` 错误进入 acquisition 的 P0 流程缺口；固定 `c47f0b4590e` 后完成 patch 回贴和 Gateway 排空重启，最终 wrapper PID `40624`、真实子进程 `40625`。sandbox **53 passed** + **6 identity-sync tests**，34 active + 6 archived gates、bundle byte/cached/reverse/index-clean 全绿。剩余 6 high 为 Electron/extract-zip/postcss/nanoid 的 Desktop/Web build-chain P2，不影响飞书主链路，未使用 `--force`。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
