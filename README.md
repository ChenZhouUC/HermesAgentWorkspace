...
| 版本               | 日期       | 周摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v0.21.0            | 2026-09-05 | **2026-W36**：upstream `11c8c05dc3 → 79445a496c`（+5603 commits），升级到 v0.21.0。官方更新完成 Python/Node 环境、web build、config v39→v40 与 bundled skills 镜像（新增 `research/llm-wiki`）；本地 43 个 active + 10 个 Archive PATCH 随上游大规模模块拆分迁移到 `turn_*`、`run_*`、`mcp_tool_*`、`slash_commands_*` 与 `doctor_*` owner modules。深审补齐 Feishu AI-authorship/冷却、原生 mention 与 Markdown post、configured-only model、MCP task/watcher、multimodal sidecar、history retention 和群聊 capability scope 的回归证据，并同步升级器及 sandbox verifier。为缩短后续回归，逐 PATCH 隔离 pytest 改为有界并行，final-audit 并发执行 full evidence、canonical suite、Wiki lint 与 Doctor，同时保留 post-canonical sandbox、cleanup、bundle 和 Gateway identity 的顺序门禁。当前 canonical patch suite **43 files / 2185 passed / 0 failed / 6 skipped**，另有 2 个 test support modules、full PATCH evidence **2191 collected**、116-file bundle、35 active + 7 archived gates、sandbox/identity-sync **161 passed**。npm 仅余 Electron/extract-zip 2 high，修复需 `--force` 升到超出上游声明范围的 Electron 40.10.6，按 P2 保留且不强制升级。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
