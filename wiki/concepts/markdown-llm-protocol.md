...
2. **Clear Semantic Boundaries**: The markers map well to LLM attention, making parsing structural context easier.^[[[_living/AI-Infrastructure/Text-Format-Protocol-for-LLMs|Text-Format-Protocol-for-LLMs]]]
