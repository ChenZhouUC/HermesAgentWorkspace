...
> 适用版本：Hermes Agent **v0.20.0**（upstream `03fa32c92dd445eb64c7f67434dd91b32c40701d` / latest `main` as of 2026-08-10）
...
> 本手册当前基于 v0.20.0（upstream `03fa32c92dd445eb64c7f67434dd91b32c40701d`）；如需固定到某个官方版本，可在 clone 后追加 `git checkout <tag-or-commit>`。
...
_文档更新时间：2026-06-22_
_对应 Hermes Agent 版本：**v0.20.0**（upstream `03fa32c92dd445eb64c7f67434dd91b32c40701d` / latest `main` as of 2026-08-10）_
