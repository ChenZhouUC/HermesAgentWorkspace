...
> 适用版本：Hermes Agent **v0.20.0**（upstream `cd9fbf9f19d937024bde2fce16b07f5400099723` / latest `main` as of 2026-08-08）
...
> 本手册当前基于 v0.20.0（upstream `cd9fbf9f19d937024bde2fce16b07f5400099723`）；如需固定到某个官方版本，可在 clone 后追加 `git checkout <tag-or-commit>`。
...
_文档更新时间：2026-06-22_
_对应 Hermes Agent 版本：**v0.20.0**（upstream `cd9fbf9f19d937024bde2fce16b07f5400099723` / latest `main` as of 2026-08-08）_
