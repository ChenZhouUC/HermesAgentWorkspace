...
> 适用版本：Hermes Agent **v0.16.0**（upstream `df4ca2c5` / latest `main` as of 2026-06-19）
...
> 本手册当前基于 v0.16.0（upstream `df4ca2c5`）；如需固定到某个官方版本，可在 clone 后追加 `git checkout <tag-or-commit>`。
...
_文档更新时间：2026-06-19_
_对应 Hermes Agent 版本：**v0.16.0**（upstream `df4ca2c5` / latest `main` as of 2026-06-19）_
