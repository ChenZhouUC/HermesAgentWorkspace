...
> 本手册当前基于 v0.17.0（upstream `b1b20270`）；如需固定到某个官方版本，可在 clone 后追加 `git checkout <tag-or-commit>`。
...
_文档更新时间：2026-06-22_
_对应 Hermes Agent 版本：**v0.17.0**（upstream `b1b20270` / latest `main` as of 2026-06-22）_
