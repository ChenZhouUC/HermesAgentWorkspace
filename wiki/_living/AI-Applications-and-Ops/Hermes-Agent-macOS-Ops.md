...
> 适用版本：Hermes Agent **v0.16.0**（upstream `ef4b897a` / latest `main` as of 2026-06-18）
...
> 本手册当前基于 v0.16.0（upstream `ef4b897a`）；如需固定到某个官方版本，可在 clone 后追加 `git checkout <tag-or-commit>`。
...
_文档更新时间：2026-06-18_
_对应 Hermes Agent 版本：**v0.16.0**（upstream `ef4b897a` / latest `main` as of 2026-06-18）_
