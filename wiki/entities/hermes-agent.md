...
Hermes 是前代智能体架构 OpenClaw 的继任者，不仅支持核心技能与记忆库的无缝平滑迁移，更是强化了如 MCP (Model Context Protocol) 协议与 PTY 交互终端的内置能力。^[[[_living/AI-Applications/Hermes-Agent-macOS-Ops|Hermes-Agent-macOS-Ops]]]
