...
- `python3 ~/.hermes/scripts/test_patch_evidence.py` — all active/archive definitions have exact four-section shape and current executable evidence; patched tests collect successfully; every non-pytest PATCH has a fresh registered probe receipt.
