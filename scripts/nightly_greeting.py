...
def build_generation_prompt(day: dt.date, session_text: str) -> str:
    return textwrap.dedent(
        ...
        - Hermes / Gödel 助手本身的开发、运维、调试与配置：例如 skill / 工具 / prompt 优化、gateway、飞书机器人、日报脚本、people.yaml / groups.yaml / config.yaml 等内部维护工作。这类「给赛博助手本身做开发」的内容一律不属于 SpaceSight 业务，绝对不写进日报。
